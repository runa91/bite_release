...
def main(args):
    ...
    pl.print('smal_keyp_conf: ' + cfg.smal.SMAL_KEYP_CONF)
    ...
    if args.command == "start":
        ...
        pl.print('Load model weights for complete model from: ' + path_model_file_complete)
    ...
    # load data sampler
    if cfg.data.DATASET == 'stanext24_withgc':
